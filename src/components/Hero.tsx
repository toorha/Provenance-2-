import { PortfolioScale } from "./PortfolioScale";
import { HERO } from "@/lib/demo-data";

export function Hero() {
  return (
    <section className="tex tex-paper relative flex min-h-screen items-center overflow-hidden bg-background pt-28 pb-16 lg:pt-24">
